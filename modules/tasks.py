...
def analyze_chart_task(self, chart_id, code, data_sample_str, user_id, sel_prov, sel_model):
    """Фоновая задача для генерации аналитического комментария к графику"""
    try:
        system_msg = (
            "Ты профессиональный бизнес-аналитик и эксперт по данным. "
            "Твоя задача: изучить код графика и предоставленный образец данных, "
            "после чего выдать краткий, но глубокий инсайт. "
            "Найди тренды, аномалии или дай совет по бизнесу. "
            "Пиши на русском языке, используй Markdown. Будь лаконичен."
        )
        
        prompt = (
            f"### КОД ГРАФИКА:\n```python\n{code}\n```\n\n"
            f"### ОБРАЗЕЦ ДАННЫХ (CSV):\n```csv\n{data_sample_str}\n```\n\n"
            f"Проанализируй это и дай 3-4 ключевых инсайта."
        )
